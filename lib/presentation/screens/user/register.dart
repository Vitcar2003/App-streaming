...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  // final _username = TextEditingController(text: "AlfredoGaby");
  // final _password = TextEditingController(text: "j7gah2xcj3");
  // final _url = TextEditingController(text: "https://homelife.blogsite.org:8443");
                          ...
                          Padding(
                            ...
                            child: CardTallButton(
                              ...
                              onTap: () {
                                ...
                                if (_username.text == "fifi-demo" &&
                                    _password.text == "fifi-demo") {
                                  context
                                      .read<SettingsCubit>()
